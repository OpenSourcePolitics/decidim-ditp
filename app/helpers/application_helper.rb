    ...
    content_tag :div, class: "row column" do
      content_tag :div, class: "breadcrumb" do
        ...
        if current_participatory_space.parent.present?
          concat(link_to(translated_attribute(current_participatory_space.parent.title), breadcrumb_assembly_path(current_participatory_space.parent)))
        end
        concat(link_to(translated_attribute(current_participatory_space.title), breadcrumb_assembly_path(current_participatory_space)))
